...
app.title("Vaccine Availabilty Information")
app.resizable(True,True)
app.config(background='#9979b8')


#FRAMES
frame1 =Frame(app,height=120,width=180,bg=coloris,bd=1,relief=FLAT)
frame1.place(x=0,y=0)
frame2 =Frame(app,height=120,width=520,bg=coloris,bd=1,relief=FLAT)
frame1.place(x=180,y=0)
frame3=Frame(app,height=30,width=700,bg='light green',bd=1,relief=RAISED)
frame3.place(x=0,y=120)

#LABELS
label_date_now = Label(text="Current Date",bg=coloris,font="Verdana 12")
label_date_now.place(x=20,y=40)
label_time_now = Label(text="Current Time",bg=coloris,font="Verdana 12")
label_time_now.place(x=20,y=60)
label_pincode = Label(text="Pincode",bg=coloris,font="Verdana 12")
label_pincode.place(x=220,y=15)
label_date=Label(text="Date",bg=coloris,font='Verdana 11')
label_date.place(x=380,y=15)
label_dateformat = Label(text="[dd-mm-yyyy]", bg = coloris, font = 'Verdana 7')
label_dateformat.place(x=420, y=18)
label_search_vacc = Label(text="Search \nAvailable Vaccine", bg = coloris, font = 'Verdana 8')
label_search_vacc.place(x=570, y=70)
label_head_result = Label(text=" Status       \tCentre-Name\t              Age-Group    Vaccine       Dose_1     Dose_2     Total", bg = 'light green', fg='black', font = 'Verdana 8 bold')
label_head_result.place(x=10, y=125)

#TEXT BOXES
pincode_text_var = StringVar()
pincode_textbox=Entry(app,width=11,bg='white',fg='black',textvariable=pincode_text_var,font='verdana 11')
pincode_textbox['textvariable'] = pincode_text_var
pincode_textbox.place(x= 220, y=40)

date_text_var = StringVar()
date_textbox = Entry(app,width = 12, bg = 'white', fg= 'black', textvariable = date_text_var, font='verdana 10')
date_textbox['textvariable'] = date_text_var
date_textbox.place(x= 380, y=40)

#RESULTBOX
result_box_avl = Text(app, height = 20, width = 8, bg='#9979b8',fg='#ecfcff', relief=FLAT, font='verdana 10')
result_box_avl.place(x= 3 , y= 152)
result_box_cent = Text(app, height = 20, width = 30, bg='#9979b8',fg='#ecfcff', relief=FLAT, font='verdana 10')
result_box_cent.place(x= 75 , y= 152)
result_box_age = Text(app, height = 20, width = 8, bg='#9979b8',fg='#ecfcff', relief=FLAT, font='verdana 10')
result_box_age.place(x= 330 , y= 152)
result_box_vacc = Text(app, height = 20, width = 10, bg='#9979b8',fg='#ecfcff', relief=FLAT, font='verdana 10')
result_box_vacc.place(x= 400 , y= 152)
result_box_D1 = Text(app, height = 20, width = 7, bg='#9979b8',fg='#ecfcff', relief=FLAT, font='verdana 10')
result_box_D1.place(x= 490 , y= 152)
result_box_D2 = Text(app, height = 20, width = 7, bg='#9979b8',fg='#ecfcff', relief=FLAT, font='verdana 10')
result_box_D2.place(x= 555 , y= 152)
result_box_D1_D2 = Text(app, height = 20, width = 7, bg='#9979b8',fg='#ecfcff', relief=FLAT, font='verdana 10')
...
def search_vaccine_avl():
    ...
    try:
        ...
        messagebox.showerror("ERROR","No Availablle center(s) for the given pincode and date")
        print(pincode_text_var.get())


            
#BUTTONS
s_vaccine_image = PhotoImage(file=r"C:\\Users\\akshi\\OneDrive\\Desktop\\image_proj\\download.png")
search_vaccine_image=s_vaccine_image.subsample(3,3)
search_vaccine_btn = Button(app, image=search_vaccine_image, height='30',width='30',bg= coloris, command = search_vaccine_avl,relief= RAISED)
search_vaccine_btn.place(x = 600,y = 25)

# Radio Buttons
curr_loc_var = StringVar()
radio_location = Radiobutton(app, text="Current location", bg= coloris, variable= curr_loc_var, value = curr_loc_var, command = fill_pincode_with_radio) #state=DISABLED
radio_location.place(x=215, y=65)

# Check Box 
chkbox_today_var = IntVar()
today_date_chkbox = Checkbutton(app, text='Today', bg= coloris, variable=chkbox_today_var, onvalue= 1, offvalue=0, command = insert_today_date)
